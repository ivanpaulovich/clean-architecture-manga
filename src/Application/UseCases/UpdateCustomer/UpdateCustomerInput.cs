// <copyright file="UpdateCustomerInput.cs" company="Ivan Paulovich">
...
namespace Application.UseCases.UpdateCustomer
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="UpdateCustomerInput" /> class.
        /// </summary>
        public UpdateCustomerInput(string firstName, string lastName, string ssn)
        {
