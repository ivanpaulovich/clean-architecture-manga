...
const unloadedState: CustomerState = { customer: { customerId: "", name: "", ssn: "" } };

export const reducer: Reducer<CustomerState> = (state: CustomerState | undefined, incomingAction: Action): CustomerState => {
    if (state === undefined) {
